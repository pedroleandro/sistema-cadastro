			...
			<section class="section">
				<div class="section-header">
					...
					<div class="section-header-breadcrumb">
						...
						<div class="breadcrumb-item">Cursos</div>
					</div>
				</div>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<button id="btn_adicionar_curso" class="btn btn-primary btn-lg btn-block col-lg-4" tabindex="4">
										Adicionar Curso
									</button>
									<div class="col-lg-3">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="tabela_cursos" class="table table-striped table-bordered">
											<thead>
											<tr>
												<th>
													#
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="form_curso" name="form_curso">
								...
								<div class="form-group">
									...
									<div class="col-lg-12">
										...
										<label class="btn btn-info btn-block">Importar Avatar
											<input type="file" id="btn_upload_curso_avatar" accept="image/*" style="display: none;">
										</label>
								...
								<div class="form-group">
									<label class="col-lg-2 control-label">Duraçao (h)</label>
									<div class="col-lg-12">
										<input id="duracao" name="duracao" type="number" class="form-control" step="0.1">
										<span class="help-block"></span>
									</div>
								</div>
								...
								<button id="btn_salvar_curso" name="btn_salvar_curso" type="submit" class="btn btn-primary btn-block col-lg-2" style="float: left">
									Salvar
								</button>
								<span class="help-block"></span>
...
<script src="<?php echo base_url();?>public/js/cursos.js"></script>

						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<button id="btn_adicionar_usuario" class="btn btn-primary btn-lg btn-block col-lg-4" tabindex="4">
										Adicionar Usuario
									</button>
									<div class="col-lg-3">
						...
						<div class="modal-body">
							<form id="form_usuario" name="form_usuario">
								...
								<div class="form-group">
									...
									<div class="col-lg-12">
										<input id="email_confirmacao" name="email_confirmacao" type="email" class="form-control" maxlength="100">
										<span class="help-block"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-lg-12">
										<input id="senha" name="senha" type="password" class="form-control" maxlength="100">
										<span class="help-block"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-lg-12">
										<input id="senha_confirmacao" name="senha_confirmacao" type="password" class="form-control" maxlength="100">
										<span class="help-block"></span>
									</div>
								</div>
								<button type="submit" id="btn_salvar_usuario" class="btn btn-primary btn-block col-lg-2" style="float: left">
									Salvar
								</button>
								<span class="help-block"></span>
								<button type="button" class="btn btn-secondary col-lg-2" style="float: right" data-dismiss="modal">Cancelar</button>
							</form>
						</div>
